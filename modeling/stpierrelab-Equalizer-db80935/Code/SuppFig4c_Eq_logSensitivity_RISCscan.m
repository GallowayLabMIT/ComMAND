% This script generates Supplementary Figure 4 C. 
% 
...
best_inducer = 1; % found from scanning in Fig. 2d
...
save('../SimulationData/SupplementaryFig4_Eq_RISCscan.mat','RISC_list','predicted_compensation')
