% This script generates data fpr Supplementary Note 5. 
% 
% Jin Yang, harvey1@mit.edu
% St-Pierre Lab (stpierrelab.com) Apr. 2021

miRNAdissociation = 0.289;
RISC = 1.7e5;
...
Array1=load('../ExperimentData/Fig4b_IFF_CV.mat');
...
box off
hold off
save('../SimulationData/SuppNote5_Predicted_Total_CV_miRNA_0.289_theta_100.mat','Eq_CV','extracell_inducer','NF_CV','IFF_CV','extracell_inducer_NF')
