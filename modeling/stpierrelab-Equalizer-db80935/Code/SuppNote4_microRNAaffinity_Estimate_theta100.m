...
theta = 100;        % fitted from CopyNumberDistribution_MeanEsitmate.m
...
save('../SimulationData/SupplementaryNote4_microRNAaffinity_estimate_theta100.mat','miRNA0','x_fmin','f_eval')
...
EQ_expmean = mean(avg);
load('../ExperimentData/SuppNote4_NF_expression_Fig4a.mat','avg')
NF_expmean = mean(avg);
