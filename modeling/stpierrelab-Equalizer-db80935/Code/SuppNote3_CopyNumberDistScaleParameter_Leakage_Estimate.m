...
for m = 1:length(leakage)
    for n = 1:length(theta)
        celltot = 1000; %Assume a total of 1000 cells
        ...
        %vector to hold simuated mean expression at each induction level
...
surf(theta,leakage,-MSE)
save('../SimulationData/SupplementaryNote3_theta_leakage_scan.mat','MSE','leakage','theta')