% This script generates Supplementary Figure 2 A (inset). 
% 
...
legend_list = {'dox = 0','dox = 1','dox = 5','dox = 10','dox = 50'};
copynumber_plot = 1:1:55;
...
for m = 1:length(extracellular_inducer)
    ...
    for i = 1:length(copynumber_plot)
        ...
        sbioloadproject ../Models/NF_model_ideal  m1
...
dosage_compensation = 1./dPOIdCN;
save('../SimulationData/SupplementaryFig2a_IdealNF_logsensitivity_inset.mat','dosage_compensation','copynumber_plot','extracellular_inducer')
