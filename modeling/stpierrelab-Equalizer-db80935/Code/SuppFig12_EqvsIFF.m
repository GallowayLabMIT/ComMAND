% This script generates Supplementary Figure 12. 
% 
...
xlim([1 1e3])
yyaxis right
plot(copynumber,RISC_Eq(:),'b--','LineWidth',3)
plot(copynumber,RISC_IFF(:),'g--','LineWidth',3)
ylim([-1e4 18e4])
ax = gca;
ax.XAxis.Color = 'k';
...
pbaspect([1 1 1])
hold off
save('../SimulationData/SupplementaryFig12_EqvsIFF.mat','copynumber','POI_Eq','POI_IFF','RISC_Eq','RISC_IFF')
