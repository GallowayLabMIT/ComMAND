% This script generates Supplementary Figure 4 D. 
% 
...
dPOIdCN = zeros(length(miRNA),length(copynumber_plot));
...
save('../SimulationData/SupplementaryFig4_IFF_microRNAaffinityScan.mat','miRNA','predicted_compensation')
